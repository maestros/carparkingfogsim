...
public class Car {
	...
	private static void createConfigurations() {
		...
		*/
		CONFIGS.put(ConfigName.CONFIG_1,
				new Configuration(3, TOTAL_NUMBER_OF_AREAS, 10, 2, false) {});
		...
		CONFIGS.put(ConfigName.CONFIG_3,
				new Configuration(3, TOTAL_NUMBER_OF_AREAS, 10, 2, true) {});
	...
	public static void main(String[] args) {
		...
		try {
			...
			controller = new Controller("master-controller", FOG_DEVICES, SENSORS, 
					ACTUATORS);
			
			controller.submitApplication(application, 
					(CLOUD_BASED)?(new ModulePlacementMapping(FOG_DEVICES, application, moduleMapping))
							:(new ModulePlacementEdgewards(FOG_DEVICES, SENSORS, ACTUATORS, application, moduleMapping)));
	...
	private static void createFogDevices(int userId, String appId) {
		...
		FogDevice proxy = createLocalGateway(cloud.getId());
		
	//	createEdgeNodes(proxy.getId());
...
//			FogDevice edgeNode = EDGE_NODES.get(index);
//			addArea(areaName, userId, appId,  edgeNode.getId());
//		}
